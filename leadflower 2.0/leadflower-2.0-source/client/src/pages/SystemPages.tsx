...
export function NotFoundPage() {
  ...
  return <SystemPage
    ...
    description="The page may have moved, or the link may be incomplete. Try the blog or the help center."
  />
}
