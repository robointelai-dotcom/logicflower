...
import {
  ...
  LayoutDashboard, Layers3, LogOut, Menu, Plug, Settings, ShieldCheck, UserCog, Users,
...
const sections: Array<{ label: string; items: NavItem[] }> = [
  { label: 'Operate', items: [
    { label: 'Overview', to: '/dashboard', icon: LayoutDashboard, roles: ['owner', 'admin', 'operator', 'viewer'] },
